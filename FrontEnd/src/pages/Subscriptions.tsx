...
import { Subscription, getSubscriptions, createSubscription, updateSubscription, deleteSubscription } from "../api/subscriptions"
...
export default function Subscriptions() {
  ...
  const [memberships, setMemberships] = useState<Array<{ id: number; name: string }>>([])
  ...
  async function load() {
    ...
    try {
      const res: any = await getSubscriptions({
        ...
        membershipId: filterMembershipId === "" ? undefined : filterMembershipId,
        ...
        <div className="card-body row g-2">
          ...
          <div className="col-md-4">
            <select
              ...
              onChange={e => setFilterMembershipId(e.target.value === "" ? "" : Number(e.target.value))}
            >
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-header">
              <h5 className="modal-title">{editing ? "Edit Subscription" : "New Subscription"}</h5>
              <button id="subscriptionModalCloseBtn" type="button" className="btn-close" data-bs-dismiss="modal" />
            </div>
              ...
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    onChange={e => setForm(f => ({ ...f, membershipId: Number(e.target.value) }))}
                  >
                    {memberships.map(m => <option key={m.id} value={m.id}>{m.name}</option>)}
                  </select>
                </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-header">
              ...
              <button id="deleteSubscriptionModalCloseBtn" type="button" className="btn-close" data-bs-dismiss="modal" />
            </div>

            <div className="modal-body">
              {pendingDelete ? (
                <p>Delete subscription <strong>#{pendingDelete.id}</strong>?</p>
              ) : (
